        ...
        <div data-custom-class="body">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt className="question">Brühlerwallstraße 5</bdt>
                      <bdt className="block-component" />
                    </span>
                  </span>
                  , <bdt className="question">Erfurt</bdt>
                </span>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: "15px" }}>
                      <span data-custom-class="body_text">
                        <span style={{ color: "rgb(89, 89, 89)" }}>
                          <bdt className="block-component" />,{" "}
                          <bdt className="question">Thueringen</bdt>
                          <bdt className="statement-end-if-in-editor" />
                          <bdt className="block-component" />{" "}
                          <bdt className="question">99084</bdt>
                          <bdt className="statement-end-if-in-editor" />
                        </span>
                      </span>
                    </span>
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <a
                            href="https://case-clicker.com/privacy-policy"
                            target="_blank"
                            data-custom-class="link"
                            rel="noreferrer"
                          >
                            https://case-clicker.com/privacy-policy
                          </a>
                        </bdt>
                      </b>
                      <span
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    If your habitual residence is in the EU, and you are a
                    consumer, you additionally possess the protection provided
                    to you by obligatory provisions of the law of your country
                    of residence.{" "}
                    <bdt className="question">Case Clicker Online</bdt> and
                    yourself both agree to submit to the non-exclusive
                    jurisdiction of the courts of{" "}
                    <bdt className="question">Thüringen</bdt>, which means that
            ...
            >
              ...
              >
                ...
                >
                  ...
                  chosen in accordance with the Arbitration and Internal Rules
                  of the European Court of Arbitration being part of the
                  ...
                  >
                    ...
                    <bdt className="question">German</bdt>.
                  </span>{" "}
              ...
              >
                ...
                >
                  <bdt
                    ...
                    data-type="question"
                  >
                    <strong>Case Clicker Online</strong>
                  </bdt>
                </span>
              </div>
              <div
                  ...
                  <strong>
                    ...
                    >
                      <bdt
                        ...
                        data-type="question"
                      >
                        <strong>info@case-clicker.com</strong>
                      </bdt>
                    </span>
                  </strong>
                </strong>
          ...
          <strong>
            <strong>
              ...
              >
                These terms of use were created using Termlys{" "}
                <a
