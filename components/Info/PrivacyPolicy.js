  ...
  return (
    <Container>
      ...
      <p>
        ...
        the Case Clicker Online. The use of the Internet pages of the Case
        Clicker Online is possible without any indication of personal data;
      ...
      <p>
        ...
        Case Clicker Online. By means of this data protection declaration, our
      ...
      <p>
        As the controller, the Case Clicker Online has implemented numerous
      ...
      <h4>1. Definitions</h4>
      <p>
        The data protection declaration of the Case Clicker Online is based on
      ...
      <p>Case Clicker Online</p>
      <p>Brühlerwallstraße 5</p>
      <p>99084 Erfurt</p>
      <p>Germany</p>
      <p>Email: info@case-clicker.com</p>
      <p>Website: https://case-clicker.com</p>

      <h4>3. Cookies</h4>
      <p>
        The Internet pages of the Case Clicker Online use cookies. Cookies are
      ...
      <p>
        Through the use of cookies, the Case Clicker Online can provide the
      ...
      <p>
        The website of the Case Clicker Online collects a series of general data
      ...
      <p>
        When using these general data and information, the Case Clicker Online
        ...
        prosecution in case of a cyber-attack. Therefore, the Case Clicker
        Online analyzes anonymously collected data and information
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            wishes to request the erasure of personal data stored by the Case
            Clicker Online, he or she may, at any time, contact any employee of
            the controller. An employee of Case Clicker Online shall promptly
          ...
          <p>
            ...
            as processing is not required. An employees of the Case Clicker
            Online will arrange the necessary measures in individual cases.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            stored by the Case Clicker Online, he or she may at any time contact
            any employee of the controller. The employee of the Case Clicker
            Online will arrange the restriction of the processing.{" "}
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            may at any time contact any employee of the Case Clicker Online.
          </p>
        </li>
        <li>
          ...
          <p>
            The Case Clicker Online shall no longer process the personal data in
          ...
          <p>
            If the Case Clicker Online processes personal data for direct
            ...
            Case Clicker Online to the processing for direct marketing purposes,
            the Case Clicker Online will no longer process the personal data for
            these purposes.
          </p>
          ...
          <p>
            ...
            data concerning him or her by the Case Clicker Online for scientific
          ...
          <p>
            ...
            contact any employee of the Case Clicker Online. In addition, the
        ...
        <li>
          ...
          <p>
            ...
            contact any employee of the Case Clicker Online.
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        <a href="https://abletorecords.com/">data protection dpia</a>. The legal
